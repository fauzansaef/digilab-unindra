    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
        <div class="page-wrapper">
           <?php include "../contents/navigation.php";?>
            ...
            <!-- END PAGE BAR -->
            <!-- BEGIN PAGE TITLE-->
            <h1 class="page-title"><i class="fa fa-arrow-left"></i>&nbsp;&nbsp;Pengembalian Buku</h1> 
            <!-- END PAGE TITLE-->
                                ...
                                <form  class="form-horizontal">
                                    <div class="table-toolbar" >
                                        <div class="form-group" >
                                            ...
                                            <div class="col-md-12">
                                                  <button id="btnTambahPengembalian" class="btn sbold grey-mint" style="float :right">  <i class="fa fa-plus"></i>&nbsp; Proses Pengembalian</button>
                                            </div>
                                        </div>                                        
                                    </div>
                                    <div id="sample_1_2_wrapper" class="dataTables_wrapper">

                                        <table class="table table-striped table-bordered table-hover table-checkable order-column dataTable" id="tblPengembalian" role="grid" aria-describedby="sample_1_2_info">
                                            ...
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th tabindex="0" aria-controls="sample_1" rowspan="1" colspan="1" aria-label=" Rendering engine : activate to sort column ascending" style="width: 140px;"> Denda </th>
...
<div id="inputPengembalianModal" class="modal fade bs-modal-lg in" tabindex="-1" aria-hidden="true" style="display: none;">
                            ...
                            <form action="#" class="form-horizontal">
                                    <div class="form-body">
										<div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" id="txtNPMPeminjam" class="form-control" placeholder="NPM Anggota">
                                            </div>
											<button type="button" id="btnCariPeminjaman" class="btn btn-success">  <i class="fa fa-search"></i>&nbsp;&nbsp;Cari</button>
                                        </div>
                                    </div>
                            </form>
							<br><br>
							
							<form class="form-horizontal id=detailPeminjam>
								<div class="form-body">
                                        <div class="form-group">

 <div id="sample_1_2_wrapper" class="dataTables_wrapper">

                                        <table class="table table-striped table-bordered table-hover table-checkable order-column dataTable" id="tblDaftarPengembalian" role="grid" aria-describedby="sample_1_2_info">
                                            <thead>
                                                <tr role="row">
                                                    <th tabindex="0" aria-controls="sample_1" rowspan="1" colspan="1" aria-label=" Rendering engine : activate to sort column ascending" style="width: 140px;"> No </th>
                                                    <th tabindex="0" aria-controls="sample_1" rowspan="1" colspan="1" aria-label=" Rendering engine : activate to sort column ascending" style="width: 140px;"> Nama Anggota </th>
                                                    ...
                                                    <th tabindex="0" aria-controls="sample_1" rowspan="1" colspan="1" aria-label=" Rendering engine : activate to sort column ascending" style="width: 140px;"> Judul Buku </th>
													<th tabindex="0" aria-controls="sample_1" rowspan="1" colspan="1" aria-label=" Rendering engine : activate to sort column ascending" style="width: 140px;"> Tgl Peminjaman </th>
													<th tabindex="0" aria-controls="sample_1" rowspan="1" colspan="1" aria-label=" Rendering engine : activate to sort column ascending" style="width: 140px;"> Tgl Harus Dikembalikan</th>
                                                </tr>
                                            </thead>
                                        </table>
										...
										<br>
										 <div class="form-group">
                                          <label class="col-md-9 control-label"><b>Note : </b>Terlambat mengembalikan denda Rp 2.000,- / hari</label>
                                        </div>
										
										
										<br>
										 <div class="form-group">
                                            <label class="col-md-3 control-label"><b>Tanggal Dikembalikan :</b></label>
                                            <div class="col-md-3">
                                                <input type="date" id="tglDikembalikan" class="form-control" placeholder="Tanngal Pengembalian" readonly>
                                            </div>
											
											<label class="col-md-3 control-label"><b>Denda : &nbsp;Rp</b></label>
                                            <div class="col-md-3">
												<input type="text" readonly id="denda" class="form-control"></label>
                                            </div>
                            	...
                            	<div class="form-actions">
                                        <div class="row">
                                            <div class="col-md-offset-3 col-md-4">
                                                <button type="button" id="btnProsesPengembalian" class="btn btn-primary">Proses</button>
