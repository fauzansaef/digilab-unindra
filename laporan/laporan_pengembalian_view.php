<?php
	...
	check_login();
	 ...
	 $page = 'laporan_pengembalian_view';
?>
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
        <div class="page-wrapper">
           <?php include "../contents/navigation.php";?>
            ...
            <!-- END PAGE BAR -->
            <!-- BEGIN PAGE TITLE-->
            <h1 class="page-title"><i class="fa fa-file-text-o"></i>&nbsp;&nbsp;Laporan Pengembalian Buku</h1> 
            <!-- END PAGE TITLE-->
                            ...
                            <div class="portlet-body">
                                <form  class="form-horizontal">
                                    ...
                                    <div id="sample_1_2_wrapper" class="dataTables_wrapper">
                                        ...
                                        <table class="table table-striped table-bordered table-hover table-checkable order-column dataTable" id="tblLaporanPengembalian" role="grid" aria-describedby="sample_1_2_info">
